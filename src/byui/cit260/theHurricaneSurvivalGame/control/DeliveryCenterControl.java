 ...
 * @author Renee
 */
public class DeliveryCenterControl {

    
    public double deliveryCenter(DeliverSupplies d, double x1, double y1, double x2, double y2) {
        ...
        returnValue = d.getDeliverCenterCost();
        return returnValue;
    }
